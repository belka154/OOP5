...
public class MyClinic {
    ...
    public static void main(String[] args) {
        ...
        Clinic c3 = new ChildrenClinic("Clinic№7", "Sovetskaia 96", "35 - 96 - 87", true, true, "39 - 89 - 99");
        Clinic c2 = new ChildrenClinic("Clinic№8", "Lenina 3", "35 - 96 -59", true, true, "39 - 89 - 12");
        Clinic c1 = new ChildrenClinic("Clinic№7", "Sovetskaia 96", "35 - 96 - 87", true, true, "39 - 89 - 99");
        Clinic c4 = new ChildrenClinic("Clinic№2", "Kirova 5", "78 - 56 - 56", false, true, "39 - 89 - 78");
         c1=c3;


        Clinic d1 = new DentalClinic("Dental Family", "Irininskaia 7", "59 - 19 - 18", false, true, "Belka154@mail.ru");
        Clinic d2 = new DentalClinic("Dental Children", "Mazurova 11", "78 - 89 - 22", false, true, "NashaDental4@mail.ru");
